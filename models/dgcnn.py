...
def residual_attn_block(point_cloud, k=20, C_out=64, C_attn=256, is_training=True, bn_decay=None, scope='attn1_'):
    """
    ...
    res1 = tf_util.conv2d(edge_feature, C_out, [1,1],
                         ...
                         scope=scope+'res1_conv1', bn_decay=bn_decay)
    ...
    res2_out = tf_util.conv2d(res2_concat, C_out, [1,1],
                              padding='VALID', stride=[1, 1],
                              bn=True, is_training=is_training,
                              scope=scope + 'res2_conv2', bn_decay=bn_decay)
